...
export function buildBatchQueueDescription(
	...
	return (
		...
		"Prefer `objective` for multi-step read/check workflows when the goal is clear; it should usually plan more than one action. Objective-planned batches can include reflection metadata (confidence, success criteria, risks).\n" +
