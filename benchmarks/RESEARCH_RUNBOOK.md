...
**Goal:** Submit a workshop paper to ICML / ICLR / NeurIPS demonstrating that migrating LLM coding agents from a single-step Sequential Read-Eval-Print-Loop (REPL) to a Queue-based Batch Architecture significantly improves task completion reliability and cuts network-bound latency.
